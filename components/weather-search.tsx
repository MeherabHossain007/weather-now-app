...
export function WeatherSearch({ onSearch, loading = false }: WeatherSearchProps) {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (value.trim().length > 0) {
      const filtered = mockCities.filter((city) => city.toLowerCase().includes(value.toLowerCase())).slice(0, 4)
